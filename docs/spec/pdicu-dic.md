...
- 第0.90版
  - 2007.7.24
  - SGM00353@niftyserve.or.jp
  - TaN

## 目次

1. <a href="anchor">はじめに</a>
2. <a href="anchor-1">辞書構造概略</a> 
   1.  <a href="anchor-2">辞書の種類</a>
   2.  <a href="anchor-3">各辞書形式の内容</a>
   3.  <a href="anchor-4">定義</a>
3. <a href="anchor-5"></span>Unicode(BOCU) 辞書 (Hyper辞書形式 Ver.6.00, Ver.6.10)</a>
   1. <a href="anchor-6">BOCU-1圧縮方式</a>
      1. <a href="anchor-7">BOCU-1の圧縮効率と検索速度</a>
   2. <a href="anchor-8">辞書全体の構成</a>
   3. <a href="anchor-9">見出語検索キー</a>
   4. <a href="anchor-10">ヘッダー部</a>
      1. <a href="anchor-11">辞書識別子</a>
      2. <a href="anchor-12">暗号化のセキュリティについて</a>
   5. <a href="anchor-13">拡張ヘッダー部</a>
      1. <a href="anchor-14">拡張ヘッダー部の構成</a>
   6. <a href="anchor-15">インデックス部</a>
      1. <a href="anchor-16">物理ブロック番号からディスク上の位置を求める</a>
      2.  ツリービューモード
   7. <a href="anchor-17">データ部</a>
      1. <a href="anchor-18">空きブロック</a>
      2. <a href="anchor-19">データブロック構成</a>
      3. <a href="anchor-20">データ部・基本構成</a>
      4. <a href="anchor-21">拡張構成</a>
      5. <a href="anchor-22">拡張構成</a>
      6. <a href="anchor-23">拡張構成</a>
      7. <a href="anchor-24">拡張部の構成１-バイナリデータフラグ、圧縮フラグ、拡張終了フラグがない場合</a>
      8. <a href="anchor-25">リンクデータの構成</a>
   8. <a href="anchor-26">リファレンス登録語→Ver.6.10で廃案</a>
   9. <a href="anchor-27">逆リファレンス辞書→Ver.6.10で廃案</a>
   10. <a href="anchor-28">PDICにおけるデータブロックの分割方法</a>
       1. <a href="anchor-29">データブロックの分割の基準 - 開発者メモ</a>
       2. <a href="anchor-30">データブロックの分割方法</a>
4. <a href="anchor-31">Unicode辞書 Ver.5.00 の構造</a>
   1. <a href="anchor-32">データブロック部</a>
      1. <a href="anchor-33">拡張構成</a>
5. <a href="anchor-34">Unicode(BOCU) 辞書 (Hyper辞書形式 Ver.5</a>
6. <a href="anchor-35">Unicode(UTF-8) 辞書</a>
7. <a href="anchor-36">Unicode(UTF-16)対応辞書</a>
8. <a href="anchor-37">履歴</a>
9. <a href="anchor-38">著作権</a>
...
# <span id="anchor-1"></span>辞書構造概略

## <span id="anchor-2"></span>辞書の種類
...
## <span id="anchor-3"></span>各辞書形式の内容
...
# <span id="anchor-5"></span>Unicode(BOCU) 辞書 (Hyper辞書形式 Ver.6.00, Ver.6.10)
...
### <span id="anchor-9"></span>見出語検索キー
    
## <span id="anchor-10"></span>ヘッダー部
...
### <span id="anchor-12"></span>暗号化のセキュリティについて
...
## <span id="anchor-13"></span>拡張ヘッダー部
...
### <span id="anchor-14"></span>拡張ヘッダー部の構成
...
## <span id="anchor-15"></span>インデックス部
...
### <span id="anchor-16"></span>物理ブロック番号からディスク上の位置を求める
...
### <span id="anchor-19"></span>データブロック構成
...
### <span id="anchor-20"></span>データ部・基本構成
...
### <span id="anchor-24"></span>拡張部の構成１-バイナリデータフラグ、圧縮フラグ、拡張終了フラグがない場合
...
### <span id="anchor-25"></span>リンクデータの構成
...
## <span id="anchor-26"></span>リファレンス登録語→Ver.6.10で廃案
...
## <span id="anchor-27"></span>逆リファレンス辞書→Ver.6.10で廃案
...
## <span id="anchor-28"></span>PDICにおけるデータブロックの分割方法
...
# <span id="anchor-31"></span>Unicode辞書 Ver.5.00 の構造
    
## <span id="anchor-32"></span>データブロック部
...
# <span id="anchor-34"></span>Unicode(BOCU) 辞書 (Hyper辞書形式 Ver.5)
...
# <span id="anchor-35"></span>Unicode(UTF-8) 辞書
...
# <span id="anchor-36"></span>Unicode(UTF-16)対応辞書
...
# <span id="anchor-37"></span>履歴

- 2007.7.2
   - 0.90版 

# <span id="anchor-38"></span>著作権
